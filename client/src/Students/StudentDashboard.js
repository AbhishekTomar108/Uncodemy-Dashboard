...
import OtherLink from './VideoAssignment'
  ...
  async function fetchStudentStatus() {
    ...
    try {
      ...
      if (status.status === "active") {
        ...
        if(status.data.paymentStatus==='Payment Notification'){
          Swal.fire({
        ...
        if(status.data.paymentStatus==='Payment Pending'){
          Swal.fire({
                        ...
                        return (
                          <li className="mb-0 ">
                            <div className='message-section'>
                              ...
                              <span className='justify-content-center'>{data.from}</span>
                            </div>
                        ...
                        {aboutStatus === true ? <div id="about-me" className="tab-pane fade active show">
                          <div className="profile-personal-info pt-4">
                            ...
                            <div className="row mb-4">
                              <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                                <h5 className="f-w-500">
                                  Payment Alert <span className="pull-right">:</span>
                                </h5>
                              </div>
                              <div className="col-lg-9 col-md-8 col-sm-6 col-6">
                                <span>{student && student.paymentStatus}</span>
                              </div>
                            </div>
                          </div>
